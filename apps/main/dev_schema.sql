...
\restrict f7X1JyL1HvdfRbctQmaZZ5tqcnhvmeU9XFwJIvIyetUaJZkLusrf6NfBXKGehYw
...
--
-- Name: create_choice_responses(text, uuid, jsonb); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: create_contact_message(text, uuid, text, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: create_early_access_request(uuid, text, text, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: upsert_lead(text, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: choices_responses; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: early_access_requests; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: page_sessions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: users_leads; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: choices_responses choices_responses_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: early_access_requests early_access_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: page_sessions page_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: users_leads users_leads_email_environment_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: users_leads users_leads_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_choices_responses_lead_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_contact_messages_lead_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_early_access_requests_lead_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_page_sessions_lead_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_users_leads_email; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: choices_responses choices_responses_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: contact_messages contact_messages_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: early_access_requests early_access_requests_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: page_sessions page_sessions_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict f7X1JyL1HvdfRbctQmaZZ5tqcnhvmeU9XFwJIvIyetUaJZkLusrf6NfBXKGehYw
